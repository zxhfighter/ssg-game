...
Breakout = {
  ...
  Defaults: {
    ...
    ball: {
      ...
      speed:   15,
      labels: {
        3: { text: '准备...', fill: '#D82800', stroke: 'black', font: 'bold 28pt arial' },
        2: { text: '重设..',    fill: '#FC9838', stroke: 'black', font: 'bold 28pt arial' },
        1: { text: '发射!',      fill: '#80D010', stroke: 'black', font: 'bold 28pt arial' }
      }
    },
  ...
  addEvents: function() {
    ...
    Game.addEvent('nextGame', 'click', this.nextGame.bind(this, false));
  ...
  winLevel: function() {
    ...
    this.score.gainLife();
    // this.nextLevel(true);
    this.ball.reset({launch: false});

    // TODO发送请求
    var gameId = SSG.GAME_MAP.BREAKOUT;
    ...
    jq('.game-pass').fadeIn('slow', function(){
      jq('#nextGame').fadeIn(100);
    });
  },
